...
public class MainActivity extends Activity {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String jsCode = "javascript:(function() { " +
                        "setInterval(function() { " +
                            ...
                            "var killList = ['Study', 'Contact Us', 'Download', 'PWTHOR owner', '@pwthor', '@pw_thor', 'Join Our Community', 'Telegram Community !!', 'Join Telegram Channel']; " +
    ...
    private void injectCustomCSS(WebView view, String url) {
        ...
        try {
            String js = "var style = document.getElementById('custom-css-injection');" +
                    ...
                    " div.flex.items-center:has(svg.lucide-contact), div.flex.items-center:has(svg.lucide-heart), div.flex.items-center:has(svg.lucide-book-open) { display: none !important; }" +
                    " \";" +
    ...
    private boolean checkAndRedirect(String url) {
        ...
        if (urlLower.contains("t.me/pw_thor") || urlLower.contains("t.me/pwthor1") ||
                urlLower.contains("/contact") || urlLower.contains("/end") || urlLower.contains("/study/study")) {
            try {
                webView.stopLoading();
                webView.loadUrl(homeUrl);
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(targetTelegram));
